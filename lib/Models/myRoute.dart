...
class MyRoute {
  static String addSongScreen = "/addSongScreen";
  static String listenSongScreen = "/listenSongScreen";
  static String optionScreen = "/optionScreen";
  static String allSongsScreen = "/allSongsScreen";
